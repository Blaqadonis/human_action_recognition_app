 ...
 **CAVEAT:**  Use this to spin up the MLflow server:   
   ...
   This will create a directory ```artifacts``` on your local machine, as well as the database ```local_server.db```. Do not spin it up yet until you are ready to track runs and make use of MLflow server. This 
   is very important.
